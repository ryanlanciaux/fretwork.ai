...
export function updateConfig(patch) {
    ...
    const next = {
        ...
        businessAddress: patch.businessAddress === undefined ? current.businessAddress : patch.businessAddress,
        businessCity: patch.businessCity === undefined ? current.businessCity : patch.businessCity,
        businessPhone: patch.businessPhone === undefined ? current.businessPhone : patch.businessPhone,
        businessLogo: patch.businessLogo === undefined
            ? current.businessLogo
            : patch.businessLogo
                ? validateLogoValue(patch.businessLogo)
                : null,
        businessTagline: patch.businessTagline === undefined ? current.businessTagline : patch.businessTagline,
        businessSite: patch.businessSite === undefined ? current.businessSite : patch.businessSite,
        accentColor: patch.accentColor === undefined ? current.accentColor : patch.accentColor,
        customInstructions: patch.customInstructions === undefined
        ...
        paymentTerms: patch.paymentTerms === undefined ? current.paymentTerms : patch.paymentTerms,
        invoiceTemplate: patch.invoiceTemplate === undefined ? current.invoiceTemplate : patch.invoiceTemplate,
        updatedAt: now,
    };
